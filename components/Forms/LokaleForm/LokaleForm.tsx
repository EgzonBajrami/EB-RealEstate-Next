...
import '../BanesaForm/BanesaForm.css'
...
const formReducer = (state:FormStateProps, action:ActionProps) => {
 ...
 export default function LokaleForm(){
  ...
  const cld:any = new Cloudinary({cloud: {cloudName: 'dhylul5fj'}});
    ...
    console.log(imagesUpload);
      ...
      const handleSubmit = async (e:React.SyntheticEvent)=>{
        ...
        console.log(data);
        const result = await fetch('/api/lokaleadd',
        {
          headers:{
    ...
    <div className="reachout-me">
        Welcome to E.B Real Estate! Shto lokale!
    </div>
