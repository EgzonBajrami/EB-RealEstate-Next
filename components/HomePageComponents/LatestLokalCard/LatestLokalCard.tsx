        ...
        return(
            <div key={index} className="single-card">
                <div className="image-holder">
                    <img src={elem.acf.lokal_image_one} alt={elem.title.rendered} />
                </div>
                <div className="title-holder">
                    <h3>{elem.title.rendered}</h3>
                </div>
                <div className="text-holder">
                    <p>{elem.acf.lokal_short_text}</p>
                </div>
                <div className="content-items">
                <h3>{elem.acf.lokal_cmimi}</h3>
                    <div className="euro">
                <span className="euro">&#8364;</span>
                </div>
          
               
                    {elem.acf.lokal_lloji==="Qera" && (
                        <span>/Muaj</span>
                    )} 
                    <div className="content-icons">
                        <div className="content-icon">
                            ...
                            <p>{elem.acf.lokal_dhoma}</p>
                                ...
                                <p>{elem.acf.lokal_metra}m<span>2</span></p>
                                </div>
                    </div>
                    </div>
