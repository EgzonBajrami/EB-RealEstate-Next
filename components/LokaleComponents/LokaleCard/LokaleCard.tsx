import './LokaleCard.css'
import Link from 'next/link'

export default function LokaleCard({data}:any){
    return<>
    <div className="lokale-page-card">
    <div  className="lokale-single-card">
                <div className="image-holder">
                    <img src={data.acf.lokal_image_one} alt={data.title.rendered} loading="lazy" />
                </div>
                <div className="title-holder">
                    <h3>{data.title.rendered}</h3>
                </div>
                <div className="text-holder">
                    <p>{data.acf.lokal_short_text}</p>
                </div>
                <div className="content-items">
                <h3>{data.acf.lokal_cmimi}</h3>
                    <div className="euro">
                <span className="euro">&#8364;</span>
                </div>
          
               
                    {data.acf.lokal_lloji==="Qera" && (
                        <span>/Muaj</span>
                    )} 
                    <div className="content-icons">
                        <div className="content-icon">
                            ...
                            <p>{data.acf.lokal_dhoma}</p>
                                ...
                                <p>{data.acf.lokal_metra}m<span>2</span></p>
                                </div>
                    </div>
                    </div>
