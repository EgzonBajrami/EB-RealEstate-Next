...
export default function Shtepia(){
    ...
    firstText="Le të filloni një kërkim të mahnitshëm për shtëpinë e ëndrrave tuaja me ndihmën e E.B Real Estate. Ne ofrojmë një gamë të gjerë shtëpish të cilat do t'ju bëjnë të ndjeheni si në parajsë. Kryeni një udhëtim virtual ose një vizitë personale në shtëpi me një ekip të përvojshëm të agjentëve tanë të pronave. Ne jemi të angazhuar në të siguruar që ju të gjeni shtëpinë e përshtatshme për stilin tuaj të jetesës, preferencat tuaja dhe nevojat tuaja të individëve. Nga shtëpitë luksoze në qytet deri te kopshtet me pamje panoramike të mrekullueshme, ne ofrojmë një portofol të pasur të pronave. Cdo shtëpi ka unikalitetin e vet dhe është kujdesur me kujdes për të përmbushur standardet më të larta të cilësisë dhe komoditetit." 
